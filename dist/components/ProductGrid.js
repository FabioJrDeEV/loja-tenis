  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {products.map((product) => (
        <article 
          className="bg-surface border border-line/30 rounded-2xl shadow-soft hover:shadow-medium hover:-translate-y-1 transition-all duration-300 overflow-hidden h-full group"
          key={product.id}
        >
          <div 
